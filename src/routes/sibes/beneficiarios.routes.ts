...
class BeneficiariosRoutes {
    ...
    config(): void{
        ...
        this.router.get('/consultar/:id/:nombre/:nombrebeneficiario/:cedula/:trabajador/:sexo/:grado/:nivelEduc/:edadIni/:edadFin/:estatus/:condlogica', beneficiariosController.beneficiariofilter);
